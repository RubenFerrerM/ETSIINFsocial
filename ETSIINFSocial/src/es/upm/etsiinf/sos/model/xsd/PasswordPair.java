...
public class PasswordPair implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * PasswordPair Namespace URI = http://model.sos.etsiinf.upm.es/xsd
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localNewpwdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://model.sos.etsiinf.upm.es/xsd", "newpwd"));
		...
		if (localOldpwdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://model.sos.etsiinf.upm.es/xsd", "oldpwd"));
						...
						if (!"PasswordPair".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (PasswordPair) es.upm.etsiinf.sos.model.xsd.ExtensionMapper
