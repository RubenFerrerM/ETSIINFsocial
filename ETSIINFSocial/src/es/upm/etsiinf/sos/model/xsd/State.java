...
public class State implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = State
	 * Namespace URI = http://model.sos.etsiinf.upm.es/xsd Namespace Prefix =
	 * ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":State", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"State", xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localMessageTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://model.sos.etsiinf.upm.es/xsd", "message"));
						...
						if (!"State".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (State) es.upm.etsiinf.sos.model.xsd.ExtensionMapper
